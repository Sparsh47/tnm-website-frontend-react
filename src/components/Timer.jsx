  ...
  const getFormattedTime = (milliseconds) => {
    ...
    return (
      <div className="lg:w-[550px] flex items-center justify-around rounded-xl my-10 gap-3">
        <div className="flex flex-col items-center bg-[rgba(255,255,255,0.05)] p-3 lg:p-5 rounded-md gap-3 flex-grow shadow-2xl">
          <span className="font-bold text-xl lg:text-4xl" style={timeStyles}>
            {days}
          </span>
          <span className="lg:text-xl" style={timeStyles}>
            Days
          </span>
        </div>
        <div className="flex flex-col items-center bg-[rgba(255,255,255,0.05)] p-3 lg:p-5 rounded-md gap-3 flex-grow shadow-2xl">
