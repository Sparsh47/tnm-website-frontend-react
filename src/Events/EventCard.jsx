...
const EventCard = ({ data }) => {
  ...
  return (
    <div
      className="w-[350px] h-[350px] md:w-[22rem] md:h-[25rem] bg-[rgba(255,255,255,0.05)] rounded-xl backdrop-blur-[1px] p-4 flex flex-col items-center gap-2 eventCard overflow-hidden"
